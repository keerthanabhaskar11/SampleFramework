...
public class CreateOrgWithPhoneNumberTest 
{
	...
	public static void main(String[] args) throws InterruptedException, IOException, FileNotFoundException
	{
		...
		//launch the browser
				...
				String CreatedPhone = driver.findElement(By.id("mouseArea_Phone")).getText();
				if(CreatedPhone.trim().equals(PhoneNumber))
				{
					System.out.println(CreatedPhone+" same as entered during Org Creation - PASS");
				}
				else
				{
					System.out.println(CreatedPhone+" different from entered during Org Creation - FAIL");
				}
